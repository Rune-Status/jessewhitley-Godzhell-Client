...
public static int offset = 33600;
    ...
    //unquote the line above if you don't use signlink.findcachedir!
    // IF you use cache/ then you must name the folder animations or it will give you
    // an unpacking config error!

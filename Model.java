...
public class Model extends Class30_Sub2_Sub4
{
    ...
    {
        int l1 = Texture.anInt1466;
        int i2 = Texture.anInt1467;
            ...
            int l1, int i2)
    {
        ...
        if(i2 > 0 && aBoolean1684)
        {
            ...
            int i6 = anInt1685 - Texture.anInt1466;
            int k6 = anInt1686 - Texture.anInt1467;
        ...
        int l5 = Texture.anInt1466;
        int j6 = Texture.anInt1467;
        int l6 = 0;
        int i7 = 0;
        if(i != 0)
        {
        ...
        if(i1 == 1)
        {
			if(settings.enableDepthBuffer)
				Texture.drawFlatTriangle(anIntArray1666[j], anIntArray1666[k],
					anIntArray1666[l], anIntArray1665[j], anIntArray1665[k],
					anIntArray1665[l], anIntArray1691[anIntArray1634[i]], vertexPerspectiveZB[j], vertexPerspectiveZB[k], vertexPerspectiveZB[l]);
			else
            Texture.method376(anIntArray1666[j], anIntArray1666[k], anIntArray1666[l], anIntArray1665[j], anIntArray1665[k], anIntArray1665[l], anIntArray1691[anIntArray1634[i]]);
            return;
        }
        if(i1 == 2)
        {
    ...
    {
        int j = Texture.anInt1466;
        int k = Texture.anInt1467;
        int l = 0;
                ...
                if(l7 == 1)
    				if(settings.enableDepthBuffer)
						Texture.drawFlatTriangle(i7, j7, k7, j3, j4, j5,
								anIntArray1691[anIntArray1634[i]], -1f, -1f, -1f);
						else
                    Texture.method376(i7, j7, k7, j3, j4, j5, anIntArray1691[anIntArray1634[i]]);
                else
                if(l7 == 2)
                {
    ...
    static int vertexPerspectiveZB[] = new int[8000];
    ...
    static 
    {
        anIntArray1689 = Texture.anIntArray1470;
        anIntArray1690 = Texture.anIntArray1471;
        anIntArray1691 = Texture.anIntArray1482;
        anIntArray1692 = Texture.anIntArray1469;
    }
}

...
anIntArray31[anInt33] = j;
	...
	public void handleInterfaceScrolling(MouseWheelEvent event) {
		...
		int tabInterfaceID = client.anIntArray1130[client.anInt1221];
		if (tabInterfaceID != -1) {
			Class9 tab = Class9.aClass9Array210[tabInterfaceID];
			offsetX = 765 - 218;
			offsetY = 503 - 298;
			for (int index = 0; index < tab.anIntArray240.length; index++) {
				if (Class9.aClass9Array210[tab.anIntArray240[index]].anInt261 > 0) {
					childID = index;
					positionX = tab.anIntArray241[index];
					positionY = tab.anIntArray272[index];
					width = Class9.aClass9Array210[tab.anIntArray240[index]].anInt220;
					height = Class9.aClass9Array210[tab.anIntArray240[index]].anInt267;
					break;
				}
			}
			if (anInt23 > offsetX + positionX && anInt24 > offsetY + positionY && anInt23 < offsetX + positionX + width && anInt24 < offsetY + positionY + height) {
				Class9.aClass9Array210[tab.anIntArray240[childID]].anInt224 += rotation * 30;
				client.aBoolean1103 = true;
				client.aBoolean1153 = true;
			}
		}
		/* Main interface scrolling */
		if (client.anInt857 != -1) {
			Class9 rsi = Class9.aClass9Array210[client.anInt857];
			offsetX = 4;
			offsetY = 4;
			for (int index = 0; index < rsi.anIntArray240.length; index++) {
				if (Class9.aClass9Array210[rsi.anIntArray240[index]].anInt261 > 0) {
					childID = index;
					positionX = rsi.anIntArray241[index];
					positionY = rsi.anIntArray272[index];
					width = Class9.aClass9Array210[rsi.anIntArray240[index]].anInt220;
					height = Class9.aClass9Array210[rsi.anIntArray240[index]].anInt267;
					break;
				}
			}
			if (anInt23 > offsetX + positionX && anInt24 > offsetY + positionY && anInt23 < offsetX + positionX + width && anInt24 < offsetY + positionY + height) {
				Class9.aClass9Array210[rsi.anIntArray240[childID]].anInt224 += rotation * 30;
			}
		}
	}
	...
	public void windowClosing(WindowEvent windowevent) {
        ...
        int userPrompt = JOptionPane.showOptionDialog(null, "Are you sure you wish to exit?", "GodzHell", 

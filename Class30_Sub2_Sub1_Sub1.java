...
public final class Class30_Sub2_Sub1_Sub1 extends DrawingArea
{
   ...
   public Class30_Sub2_Sub1_Sub1(byte abyte0[], Component component)
    {
        ...
        try
        {
            ...
            Image image = Toolkit.getDefaultToolkit().getImage(signlink.findcachedir()+"Sprites/oldkoscape.png");
...
try
{
	...
	else if (s.equalsIgnoreCase("compass"))
	{
		try
	{
				Image image = Toolkit.getDefaultToolkit().getImage(signlink.findcachedir()+"Sprites/COMPASS 0.png");
				anIntArray1439 = new int[anInt1440 * anInt1441];
				PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
				pixelgrabber.grabPixels();
			}
    ...
    public void method343(int i)
    {
        ...
        DrawingArea.initDrawingArea(anInt1441, anInt1440, -293, anIntArray1439, null);
    }
    ...
    public void method346(int i, int j, int k)
    {
        ...
        {
            method347(l, k1, j1, i2, i1, 28339, l1, anIntArray1439, DrawingArea.pixels);
            return;
        }
    }
    ...
    public void method348(int i, int j, int k)
    {
        ...
        {
            method349(DrawingArea.pixels, anIntArray1439, 0, i1, l, k1, j1, l1, i2);
            return;
        }
    }
    ...
    public void method350(int i, int j, int k, boolean flag)
    {
        ...
        {
            method351(j1, l1, DrawingArea.pixels, 0, anIntArray1439, j2, k1, i2, k, i1, 8);
            return;
        }
    }
            ...
            int j1, int k1, int l1, int i2)
    {
        ...
        try
        {
            ...
            for(j1 = 0; j1 < i; j1++)
            {
                ...
                {
                    DrawingArea.pixels[j4++] = anIntArray1439[(k4 >> 16) + (l4 >> 16) * anInt1440];
                    k4 += i3;
                    l4 -= l2;
                }
    ...
    public void method354(Class30_Sub2_Sub1_Sub2 class30_sub2_sub1_sub2, boolean flag, int i, int j)
    {
        ...
        {
            method355(anIntArray1439, j1, class30_sub2_sub1_sub2.aByteArray1450, i1, DrawingArea.pixels, 0, aBoolean1436, k1, k, l1, l);
            return;
        }
    }

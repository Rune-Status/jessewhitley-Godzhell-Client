...
Model.method460(buffer, -4036, Integer.parseInt(getFileNameWithoutExtension(sss)));
}
}
...
catch(Exception e)
{
    ...
    public final void method16() {
  	  int j = 5;
  		...
  		while(anIntArray1090[8] == 0)
  		{
  			...
  			method13(20, (byte) 4, "Connecting to GodzHell web server");
  			try
  			{
    ...
    public final void method18(int i) {
        ...
        if (aBoolean1256) {
            ...
            int j = 0;
            DrawingArea.setDrawingArea(77, 0, false, 463, 0);
            for (int k = 0; k < 100; k++)
            ...
            DrawingArea.defaultDrawingAreaSize(4);
            anInt1211 = j * 14 + 7;
            if (anInt1211 < 78)
                anInt1211 = 78;
            ...
            DrawingArea.method339(77, 0, 479, 0, (byte) 4);
        }
    ...
    public final void init() {
        try {
            ...
            setserver(settings.localHost ? settings.localAddress : settings.liveAddress, "43594");
...
aClass11Array1230[k1].anIntArrayArray294[i2][k2] = 0;
    ...
    public final void method21(boolean flag, int i, byte abyte0[]) {
        ...
        signlink.wavesave(abyte0, abyte0.length);
        if (i != 0)
            anInt1008 = aClass30_Sub2_Sub2_1083.method408();
    }
    ...
    private void menuActionsRow(String action, int index, int actionID, int row) {
        if (!this.aBoolean885) {
            this.aStringArray1199[index] = action;
            this.anIntArray1093[index] = actionID;
            this.anInt1133 = row;
        }
                                ...
                                if (class9_1.anIntArray253[k2] > 0) {
                                    ...
                                    if (anInt1282 == 1 && class9_1.aBoolean249) {
                                            ...
                                            for (int l3 = 4; l3 >= 3; l3--)
                                                if (class8.aStringArray189 != null && class8.aStringArray189[l3] != null) {
                                                    ...
                                                    if (l3 == 4)
														...
														hasDestroyOption = class8.aStringArray189[l3].contains("Destroy");
                                                    anIntArray1094[anInt1133] = class8.anInt157;
                                                    anIntArray1091[anInt1133] = k2;
                                                    anIntArray1092[anInt1133] = class9_1.anInt250;
                                                    anInt1133++;
                                        ...
                                        if (class9_1.aBoolean242) {
                                            ...
                                            anIntArray1092[anInt1133] = class9_1.anInt250;
                                            anInt1133++;
											if (!hasDestroyOption && !aBoolean885 && shiftDrop && shiftDown) {
                                                menuActionsRow("Drop @lre@" + class8.aString170, 1, 847, 2);
                                        ...
                                        if (class9_1.aStringArray225 != null) {
                                            for (int j4 = 4; j4 >= 0; j4--)
                                                if (class9_1.aStringArray225[j4] != null) {
												 ...
												 if (!hasDestroyOption && !this.aBoolean885 && shiftDrop && shiftDown) {
                                                this.menuActionsRow("Drop @lre@" + class8.aString170, 1, 847, 2);
                                                removeShiftDropOnMenuOpen = true;
                                            }
    ...
    public final void method30(int i, int j, int k, int l, int i1, int j1) {
        ...
        DrawingArea.method336(j - 32, l + 16, i1, 0x000001, 16, 0);
        DrawingArea.method336(j - 32, l + 16, i1, 0x3d3426, 15, 0);
        DrawingArea.method336(j - 32, l + 16, i1, 0x342d21, 13, 0);
        DrawingArea.method336(j - 32, l + 16, i1, 0x2e281d, 11, 0);
        DrawingArea.method336(j - 32, l + 16, i1, 0x29241b, 10, 0);
        DrawingArea.method336(j - 32, l + 16, i1, 0x252019, 9, 0);
        DrawingArea.method336(j - 32, l + 16, i1, 0x000001, 1, 0);
        int k1 = ((j - 32) * j) / j1;
        if (k1 < 8)
            k1 = 8;
        int l1 = ((j - 32 - k1) * k) / (j1 - j);
        DrawingArea.method336(k1, l + 16 + l1, i1, anInt1063, 16, 0);
        DrawingArea.method341(l + 16 + l1, 0x000001, k1, i1, anInt1135);
        DrawingArea.method341(l + 16 + l1, 0x817051, k1, i1 + 1, anInt1135);
        DrawingArea.method341(l + 16 + l1, 0x73654a, k1, i1 + 2, anInt1135);
        DrawingArea.method341(l + 16 + l1, 0x6a5c43, k1, i1 + 3, anInt1135);
        DrawingArea.method341(l + 16 + l1, 0x6a5c43, k1, i1 + 4, anInt1135);
        DrawingArea.method341(l + 16 + l1, 0x655841, k1, i1 + 5, anInt1135);
        DrawingArea.method341(l + 16 + l1, 0x655841, k1, i1 + 6, anInt1135);
        DrawingArea.method341(l + 16 + l1, 0x61553e, k1, i1 + 7, anInt1135);
        DrawingArea.method341(l + 16 + l1, 0x61553e, k1, i1 + 8, anInt1135);
        DrawingArea.method341(l + 16 + l1, 0x5d513c, k1, i1 + 9, anInt1135);
        DrawingArea.method341(l + 16 + l1, 0x5d513c, k1, i1 + 10, anInt1135);
        DrawingArea.method341(l + 16 + l1, 0x594e3a, k1, i1 + 11, anInt1135);
        DrawingArea.method341(l + 16 + l1, 0x594e3a, k1, i1 + 12, anInt1135);
        DrawingArea.method341(l + 16 + l1, 0x514635, k1, i1 + 13, anInt1135);
        DrawingArea.method341(l + 16 + l1, 0x4b4131, k1, i1 + 14, anInt1135);
        DrawingArea.method339(l + 16 + l1, 0x000001, 15, i1, (byte) 4);
        DrawingArea.method339(l + 17 + l1, 0x000001, 15, i1, (byte) 4);
        DrawingArea.method339(l + 17 + l1, 0x655841, 14, i1, (byte) 4);
        DrawingArea.method339(l + 17 + l1, 0x6a5c43, 13, i1, (byte) 4);
        DrawingArea.method339(l + 17 + l1, 0x6d5f48, 11, i1, (byte) 4);
        DrawingArea.method339(l + 17 + l1, 0x73654a, 10, i1, (byte) 4);
        DrawingArea.method339(l + 17 + l1, 0x76684b, 7, i1, (byte) 4);
        DrawingArea.method339(l + 17 + l1, 0x7b6a4d, 5, i1, (byte) 4);
        DrawingArea.method339(l + 17 + l1, 0x7e6e50, 4, i1, (byte) 4);
        DrawingArea.method339(l + 17 + l1, 0x817051, 3, i1, (byte) 4);
        DrawingArea.method339(l + 17 + l1, 0x000001, 2, i1, (byte) 4);
        DrawingArea.method339(l + 18 + l1, 0x000001, 16, i1, (byte) 4);
        DrawingArea.method339(l + 18 + l1, 0x564b38, 15, i1, (byte) 4);
        DrawingArea.method339(l + 18 + l1, 0x5d513c, 14, i1, (byte) 4);
        DrawingArea.method339(l + 18 + l1, 0x625640, 11, i1, (byte) 4);
        DrawingArea.method339(l + 18 + l1, 0x655841, 10, i1, (byte) 4);
        DrawingArea.method339(l + 18 + l1, 0x6a5c43, 7, i1, (byte) 4);
        DrawingArea.method339(l + 18 + l1, 0x6e6046, 5, i1, (byte) 4);
        DrawingArea.method339(l + 18 + l1, 0x716247, 4, i1, (byte) 4);
        DrawingArea.method339(l + 18 + l1, 0x7b6a4d, 3, i1, (byte) 4);
        DrawingArea.method339(l + 18 + l1, 0x817051, 2, i1, (byte) 4);
        DrawingArea.method339(l + 18 + l1, 0x000001, 1, i1, (byte) 4);
        DrawingArea.method339(l + 19 + l1, 0x000001, 16, i1, (byte) 4);
        DrawingArea.method339(l + 19 + l1, 0x514635, 15, i1, (byte) 4);
        DrawingArea.method339(l + 19 + l1, 0x564b38, 14, i1, (byte) 4);
        DrawingArea.method339(l + 19 + l1, 0x5d513c, 11, i1, (byte) 4);
        DrawingArea.method339(l + 19 + l1, 0x61553e, 9, i1, (byte) 4);
        DrawingArea.method339(l + 19 + l1, 0x655841, 7, i1, (byte) 4);
        DrawingArea.method339(l + 19 + l1, 0x6a5c43, 5, i1, (byte) 4);
        DrawingArea.method339(l + 19 + l1, 0x6e6046, 4, i1, (byte) 4);
        DrawingArea.method339(l + 19 + l1, 0x73654a, 3, i1, (byte) 4);
        DrawingArea.method339(l + 19 + l1, 0x817051, 2, i1, (byte) 4);
        DrawingArea.method339(l + 19 + l1, 0x000001, 1, i1, (byte) 4);
        DrawingArea.method339(l + 20 + l1, 0x000001, 16, i1, (byte) 4);
        DrawingArea.method339(l + 20 + l1, 0x4b4131, 15, i1, (byte) 4);
        DrawingArea.method339(l + 20 + l1, 0x544936, 14, i1, (byte) 4);
        DrawingArea.method339(l + 20 + l1, 0x594e3a, 13, i1, (byte) 4);
        DrawingArea.method339(l + 20 + l1, 0x5d513c, 10, i1, (byte) 4);
        DrawingArea.method339(l + 20 + l1, 0x61553e, 8, i1, (byte) 4);
        DrawingArea.method339(l + 20 + l1, 0x655841, 6, i1, (byte) 4);
        DrawingArea.method339(l + 20 + l1, 0x6a5c43, 4, i1, (byte) 4);
        DrawingArea.method339(l + 20 + l1, 0x73654a, 3, i1, (byte) 4);
        DrawingArea.method339(l + 20 + l1, 0x817051, 2, i1, (byte) 4);
        DrawingArea.method339(l + 20 + l1, 0x000001, 1, i1, (byte) 4);
        if (i <= 0)
            anInt1105 = aClass17_1000.method246();
        DrawingArea.method341(l + 16 + l1, 0x000001, k1, i1 + 15, anInt1135);
        DrawingArea.method339(l + 15 + l1 + k1, 0x000001, 16, i1, (byte) 4);
        DrawingArea.method339(l + 14 + l1 + k1, 0x000001, 15, i1, (byte) 4);
        DrawingArea.method339(l + 14 + l1 + k1, 0x3f372a, 14, i1, (byte) 4);
        DrawingArea.method339(l + 14 + l1 + k1, 0x443c2d, 10, i1, (byte) 4);
        DrawingArea.method339(l + 14 + l1 + k1, 0x483e2f, 9, i1, (byte) 4);
        DrawingArea.method339(l + 14 + l1 + k1, 0x4a402f, 7, i1, (byte) 4);
        DrawingArea.method339(l + 14 + l1 + k1, 0x4b4131, 4, i1, (byte) 4);
        DrawingArea.method339(l + 14 + l1 + k1, 0x564b38, 3, i1, (byte) 4);
        DrawingArea.method339(l + 14 + l1 + k1, 0x000001, 2, i1, (byte) 4);
        DrawingArea.method339(l + 13 + l1 + k1, 0x000001, 16, i1, (byte) 4);
        DrawingArea.method339(l + 13 + l1 + k1, 0x443c2d, 15, i1, (byte) 4);
        DrawingArea.method339(l + 13 + l1 + k1, 0x4b4131, 11, i1, (byte) 4);
        DrawingArea.method339(l + 13 + l1 + k1, 0x514635, 9, i1, (byte) 4);
        DrawingArea.method339(l + 13 + l1 + k1, 0x544936, 7, i1, (byte) 4);
        DrawingArea.method339(l + 13 + l1 + k1, 0x564b38, 6, i1, (byte) 4);
        DrawingArea.method339(l + 13 + l1 + k1, 0x594e3a, 4, i1, (byte) 4);
        DrawingArea.method339(l + 13 + l1 + k1, 0x625640, 3, i1, (byte) 4);
        DrawingArea.method339(l + 13 + l1 + k1, 0x6a5c43, 2, i1, (byte) 4);
        DrawingArea.method339(l + 13 + l1 + k1, 0x000001, 1, i1, (byte) 4);
        DrawingArea.method339(l + 12 + l1 + k1, 0x000001, 16, i1, (byte) 4);
        DrawingArea.method339(l + 12 + l1 + k1, 0x443c2d, 15, i1, (byte) 4);
        DrawingArea.method339(l + 12 + l1 + k1, 0x4b4131, 14, i1, (byte) 4);
        DrawingArea.method339(l + 12 + l1 + k1, 0x544936, 12, i1, (byte) 4);
        DrawingArea.method339(l + 12 + l1 + k1, 0x564b38, 11, i1, (byte) 4);
        DrawingArea.method339(l + 12 + l1 + k1, 0x594e3a, 10, i1, (byte) 4);
        DrawingArea.method339(l + 12 + l1 + k1, 0x5d513c, 7, i1, (byte) 4);
        DrawingArea.method339(l + 12 + l1 + k1, 0x61553e, 4, i1, (byte) 4);
        DrawingArea.method339(l + 12 + l1 + k1, 0x6e6046, 3, i1, (byte) 4);
        DrawingArea.method339(l + 12 + l1 + k1, 0x7b6a4d, 2, i1, (byte) 4);
        DrawingArea.method339(l + 12 + l1 + k1, 0x000001, 1, i1, (byte) 4);
        DrawingArea.method339(l + 11 + l1 + k1, 0x000001, 16, i1, (byte) 4);
        DrawingArea.method339(l + 11 + l1 + k1, 0x4b4131, 15, i1, (byte) 4);
        DrawingArea.method339(l + 11 + l1 + k1, 0x514635, 14, i1, (byte) 4);
        DrawingArea.method339(l + 11 + l1 + k1, 0x564b38, 13, i1, (byte) 4);
        DrawingArea.method339(l + 11 + l1 + k1, 0x594e3a, 11, i1, (byte) 4);
        DrawingArea.method339(l + 11 + l1 + k1, 0x5d513c, 9, i1, (byte) 4);
        DrawingArea.method339(l + 11 + l1 + k1, 0x61553e, 7, i1, (byte) 4);
        DrawingArea.method339(l + 11 + l1 + k1, 0x655841, 5, i1, (byte) 4);
        DrawingArea.method339(l + 11 + l1 + k1, 0x6a5c43, 4, i1, (byte) 4);
        DrawingArea.method339(l + 11 + l1 + k1, 0x73654a, 3, i1, (byte) 4);
        DrawingArea.method339(l + 11 + l1 + k1, 0x7b6a4d, 2, i1, (byte) 4);
        DrawingArea.method339(l + 11 + l1 + k1, 0x000001, 1, i1, (byte) 4);
    }
    ...
    public final void method33(boolean flag, int i) {
        ...
        if (j == 1) {
            if (k == 1)
                Texture.method372(0.90000000000000002D, aByte1200);
            if (k == 2)
                Texture.method372(0.80000000000000004D, aByte1200);
            if (k == 3)
                Texture.method372(0.69999999999999996D, aByte1200);
            if (k == 4)
                Texture.method372(0.59999999999999998D, aByte1200);
            Class8.aClass12_158.method224();
            aBoolean1255 = true;
        }
		if (j == 3) {
			...
			if (k == 0) {
				method123((byte) 0,musicEnabled, 500);
				musicEnabled = true;
			}
			if (k == 1) {
				method123((byte) 0, musicEnabled, 300);
				musicEnabled = true;
			}
			if (k == 2) {
				method123((byte) 0,musicEnabled, 100);
				musicEnabled = true;
			}
			if (k == 3) {
				method123((byte) 0, musicEnabled, 0);
				musicEnabled = true;
			}
			if (k == 4) {
				musicEnabled = false;
         ...
         if(var3 != null && ((Class30_Sub2_Sub4_Sub1)((Class30_Sub2_Sub4_Sub1)var3)).method449(aBoolean1224)) {
            ...
            if(var3 instanceof Class30_Sub2_Sub4_Sub1_Sub1) {
               ...
               if(var4.anIntArray88 != null) {
                  var4 = var4.method161(this.anInt877);
               }
            ...
            if(((Class30_Sub2_Sub4_Sub1)((Class30_Sub2_Sub4_Sub1)var3)).anInt1532 > anInt1161) {
               ...
               if(this.anInt963 > -1) {
                  ...
                  DrawingArea.method336(5, this.anInt964 - 3, this.anInt963 - 15, '\uff00', var14, 0);
                  DrawingArea.method336(5, this.anInt964 - 3, this.anInt963 - 15 + var14, 16711680, 30 - var14, 0);
               }
            }
      ...
      for(var2 = 0; var2 < this.anInt974; ++var2) {
         ...
         if(this.anInt1249 == 0) {
            ...
            if(this.anIntArray981[var2] == 4) {
               ...
               DrawingArea.setDrawingArea(334, this.anInt963 - 50, false, this.anInt963 + 50, 0);
            ...
            if(this.anIntArray981[var2] == 5) {
               ...
               DrawingArea.setDrawingArea(this.anInt964 + 5, 0, false, 512, this.anInt964 - this.aClass30_Sub2_Sub1_Sub4_1272.anInt1497 - 1);
    ...
    public final void method37(int i, int j) {
        ...
        if (!lowMemory) {
            if (Texture.anIntArray1480[17] >= j) {
                Class30_Sub2_Sub1_Sub2 class30_sub2_sub1_sub2 = Texture.aClass30_Sub2_Sub1_Sub2Array1474[17];
            ...
            if (Texture.anIntArray1480[24] >= j) {
                Class30_Sub2_Sub1_Sub2 class30_sub2_sub1_sub2_1 = Texture.aClass30_Sub2_Sub1_Sub2Array1474[24];
            ...
            if (Texture.anIntArray1480[40] >= j) {
                Class30_Sub2_Sub1_Sub2 class30_sub2_sub1_sub2_1 = Texture.aClass30_Sub2_Sub1_Sub2Array1474[40];
                int l = class30_sub2_sub1_sub2_1.anInt1452 * class30_sub2_sub1_sub2_1.anInt1453 - 1;
                int k1 = class30_sub2_sub1_sub2_1.anInt1452 * anInt945 * 2;
                byte abyte1[] = class30_sub2_sub1_sub2_1.aByteArray1450;
                byte abyte4[] = aByteArray912;
            ...
            if (Texture.anIntArray1480[34] >= j) {
                Class30_Sub2_Sub1_Sub2 class30_sub2_sub1_sub2_2 = Texture.aClass30_Sub2_Sub1_Sub2Array1474[34];
   ...
   public final void method40(byte var1) {
      int var2 = this.anInt949;
      int var3 = this.anInt950;
      int var4 = this.anInt951;
      int var5 = this.anInt952;
      int var6 = 6116423;
      DrawingArea.method336(var5, var3, var2, var6, var4, 0);
      if(var1 == 9) {
         boolean var12 = false;
         DrawingArea.method336(16, var3 + 1, var2 + 1, 0, var4 - 2, 0);
         DrawingArea.method337(var2 + 1, var4 - 2, var5 - 19, 0, var3 + 18, true);
         this.aClass30_Sub2_Sub1_Sub4_1272.method385(var6, "Choose Option", var3 + 14, 822, var2 + 3);
         int var7 = super.anInt20;
         int var8 = super.anInt21;
         if(this.anInt948 == 0) {
            var7 -= 4;
            var8 -= 4;
         }
         ...
         for(int var9 = 0; var9 < this.anInt1133; ++var9) {
            int var10 = var3 + 31 + (this.anInt1133 - 1 - var9) * 15;
            int var11 = 16777215;
            if(var7 > var2 && var7 < var2 + var4 && var8 > var10 - 13 && var8 < var10 + 3) {
               var11 = 16776960;
            }

            this.aClass30_Sub2_Sub1_Sub4_1272.method389(false, true, var2 + 3, var11, this.aStringArray1199[var9], var10);
         }
    ...
    public final void method47(int i, boolean flag) {
        ...
        for (int l = 0; l < j; l++) {
            ...
            if ((lowMemory && anInt891 > 50 || anInt891 > 200) && !flag && ((Class30_Sub2_Sub4_Sub1) (class30_sub2_sub4_sub1_sub2)).anInt1517 == ((Class30_Sub2_Sub4_Sub1) (class30_sub2_sub4_sub1_sub2)).anInt1511)
...
//               aClass30_Sub2_Sub1_Sub2Array1152[l] = new Class30_Sub2_Sub1_Sub2(aClass44_1053, "runes", 12 + (l & 3));
    ...
    public final void method53(int i) {
        if (i != -48877)
            return;
        if (lowMemory && anInt1023 == 2 && Class7.anInt131 != anInt918) {
            aClass15_1165.method237(0);
        ...
        if (anInt1023 == 1) {
            ...
            if (j != 0 && System.currentTimeMillis() - aLong824 > 0x57e40L) {
                signlink.reporterror(aString1173 + " glcfb " + aLong1215 + "," + j + "," + lowMemory + "," + aClass14Array970[0] + "," + onDemandFetcher.method552() + "," + anInt918 + "," + anInt1069 + "," + anInt1070);
                aLong824 = System.currentTimeMillis();
            }
        }
    ...
    public final void method57(boolean flag) {
        ...
        do {
            ...
            do {
                ...
                if (class30_sub2_sub3.anInt1419 == 2 && class30_sub2_sub3.anInt1421 == nextSong && class30_sub2_sub3.aByteArray1420 != null)
                    method21(songChanging, 0, class30_sub2_sub3.aByteArray1420);
            ...
            Class7.method173((byte) -107, new Class30_Sub2_Sub2(class30_sub2_sub3.aByteArray1420, 891), onDemandFetcher);
        } while (true);
    }
...
*/
    ...
    public final void method62(int i) {
        ...
        if (anInt1086 != 0) {
            ...
            if (super.anInt19 == 0) {
                ...
                } else if ((anInt1253 == 1 || method17(9, anInt1133 - 1)) && anInt1133 > 2)
                    method116(true);
                else if (anInt1133 > 0)
                    method69(anInt1133 - 1, false);
                anInt1243 = 10;
    ...
    public final void method64(int i) {
        ...
        DrawingArea.setAllPixelsToZero(aBoolean1206);
    ...
    public final void method13(int i, byte byte0, String s) {
        ...
        char c1 = '\310';
        byte byte1 = 20;
        aClass30_Sub2_Sub1_Sub4_1272.method381(128, "GodzHell client is loading - please wait...", 23693, c1 / 2 - 26 - byte1, c / 2);
        int j = c1 / 2 - 18 - byte1;
        // Colours
        DrawingArea.method337(c / 2 - 152, 304, 34, 0xf5fffa, j, true);
        DrawingArea.method337(c / 2 - 151, 302, 32, 0, j + 1, true);
        DrawingArea.method336(30, j + 2, c / 2 - 150, 0x778899, i * 3, 0);
        DrawingArea.method336(30, j + 2, (c / 2 - 150) + i * 3, 0, 300 - i * 3, 0);
    ...
    public final void method75(int i, Class9 class9) {
        ...
        if (j >= 101 && j <= 200 || j >= 801 && j <= 900) {
            ...
            else if (/*anIntArray826[j] == anInt957*/anIntArray826[j] == 1)
    ...
    public final void method84(String s, String s1, boolean flag) {
        ...
        try {
            if (!flag) {
                this.aString1266 = "@xxx@Connecting";
                this.aString1267 = "@xxx@Please wait...";
            ...
            if (k == 0) {
                ...
                aClass30_Sub2_Sub2_847.method398(lowMemory ? 1 : 0);
                for (int l1 = 0; l1 < 9; l1++)
        ...
        for (int j = 0; j < anInt893; j++) {
            ...
            if ((l & 0x10) != 0) {
                ...
                if (i1 == ((Class30_Sub2_Sub4_Sub1) (class30_sub2_sub4_sub1_sub1)).anInt1526 && i1 != -1) {
                    ...
                    if (l2 == 2)
                        class30_sub2_sub4_sub1_sub1.anInt1530 = 0;
                } else if (i1 == -1 || ((Class30_Sub2_Sub4_Sub1) (class30_sub2_sub4_sub1_sub1)).anInt1526 == -1 || Class20.aClass20Array351[i1].anInt359 >= Class20.aClass20Array351[((Class30_Sub2_Sub4_Sub1) (class30_sub2_sub4_sub1_sub1)).anInt1526].anInt359) {
    ...
    public final void method88(int i, int j, Class30_Sub2_Sub4_Sub1_Sub2 class30_sub2_sub4_sub1_sub2, boolean flag, int k) {
        ...
        for (int i1 = 0; i1 < anInt1133; i1++)
            if (anIntArray1093[i1] == 516) {
                aStringArray1199[i1] = "Attack @whi@" + s;
                return;
            }
...
//                            }
	...
	CacheDownloader.start(this, CacheDownloader.FileType.FILEDATA);
        ...
        try {
            ...
            method56(0);
            method51(215);
            Class44 class44 = method67(2, "GodzHell config", "config", anIntArray1090[2], (byte) -41, 30);
            Class44 class44_1 = method67(3, "GodzHell interface", "interface", anIntArray1090[3], (byte) -41, 35);
            Class44 class44_2 = method67(4, "GodzHell 2d graphics", "media", anIntArray1090[4], (byte) -41, 40);
            Class44 class44_3 = method67(6, "GodzHell textures", "textures", anIntArray1090[6], (byte) -41, 45);
            Class44 class44_4 = method67(7, "GodzHell chat system", "wordenc", anIntArray1090[7], (byte) -41, 50);
            Class44 class44_5 = method67(8, "GodzHell sound effects", "sounds", anIntArray1090[8], (byte) -41, 55);
            ...
            method13(60, (byte) 4, "Connecting to GodzHell  update server");
            onDemandFetcher = new Class42_Sub1();
            onDemandFetcher.method551(class44_6, this);
...
return;
            ...
            method13(65, (byte) 4, "Requesting GodzHell animations");
            ...
            while (onDemandFetcher.method552() > 0) {
                ...
                if (j1 > 0)
                    method13(65, (byte) 4, "Loading GodzHell animations - " + (j1 * 100) / k + "%");
                method57(false);
                try {
                    Thread.sleep(100L);
                } catch (Exception _ex) {
            ...
            method13(70, (byte) 4, "Requesting GodzHell models");
            ...
            while (onDemandFetcher.method552() > 0) {
                ...
                if (i2 > 0)
                    method13(70, (byte) 4, "Loading GodzHell models - " + (i2 * 100) / k + "%");
                method57(false);
                try {
                    Thread.sleep(100L);
                } catch (Exception _ex) {
            ...
            if (aClass14Array970[0] != null) {
                method13(75, (byte) 4, "Requesting GodzHell maps");
                ...
                while (onDemandFetcher.method552() > 0) {
                    ...
                    if (j2 > 0)
                        method13(75, (byte) 4, "Loading GodzHell maps - " + (j2 * 100) / k + "%");
                    method57(false);
                    try {
                        Thread.sleep(100L);
                    } catch (Exception _ex) {
            ...
            method13(80, (byte) 4, "Loading GodzHell Maps");
            System.out.println("Welcome to GodzHell.com");
          ...
          /*  try
            ...
            aClass30_Sub2_Sub1_Sub1_1144 = new Class30_Sub2_Sub1_Sub1(class44_2, "redstone2", 0);
            flip = true;
            ...
            aClass30_Sub2_Sub1_Sub1_1147 = new Class30_Sub2_Sub1_Sub1(class44_2, "redstone2", 0);
            flip = false;
            flip_s = true;
            ...
            method13(83, (byte) 4, "Unpacking GodzHell textures");
            Texture.method368(class44_3, 0);
            Texture.method372(0.80000000000000004D, aByte1200);
            Texture.method367(20, true);
            method13(86, (byte) 4, "Unpacking GodzHell config");
            ...
            if (!lowMemory) {
                method13(90, (byte) 4, "Unpacking GodzHell sounds");
            ...
            method13(95, (byte) 4, "Unpacking GodzHell interfaces");
            ...
            Texture.method365(-950, 479, 96);
            anIntArray1180 = Texture.anIntArray1472;
            Texture.method365(-950, 190, 261);
    ...
    public final void method92(boolean flag) {
        ...
        if (super.anInt26 == 1) {
            ...
            if (i >= 0 && j >= 0 && i < 146 && j < 151) {
				...
				if ((controlIsDown && this.anInt1225 == 0)) {
					if (anInt863 >= 2) {
					this.teleport(this.anInt1034 + i2, this.anInt1035 + j2);
					}
				} else {
    ...
    public final void method94(int i) {
        ...
        if (aBoolean926) {
            ...
            int k = 35;
            g.drawString("Sorry, an error has occured whilst loading Demolishscape", 30, k);
            k += 50;
...
//						Class30_Sub2_Sub1_Sub4_1271.method382(0xffffff, 55, anInt939, class30_sub2_sub1_sub4.method383(anInt1116, s + ": "), 28, true);
    ...
    public final void method105(int i, int j, int k, Class9 class9, int l) {
        ...
        DrawingArea.setDrawingArea(l + class9.anInt267, k, false, k + class9.anInt220, l);
                ...
                if (class9_1.anInt262 == 2) {
                    ...
                    for (int l3 = 0; l3 < class9_1.anInt267; l3++) {
                        for (int l4 = 0; l4 < class9_1.anInt220; l4++) {
                            ...
                            if (class9_1.anIntArray253[i3] > 0) {
                                ...
                                if (k5 > DrawingArea.topX - 32 && k5 < DrawingArea.bottomX && j6 > DrawingArea.topY - 32 && j6 < DrawingArea.bottomY || anInt1086 != 0 && anInt1085 == i3) {
                                    int l9 = 0;
                    ...
                    if (class9_1.aByte254 == 0) {
                        if (class9_1.aBoolean227)
                            DrawingArea.method336(class9_1.anInt267, l2, k2, j3, class9_1.anInt220, 0);
                        else
                    ...
                    int k3 = Texture.anInt1466;
                    int j4 = Texture.anInt1467;
                    Texture.anInt1466 = k2 + class9_1.anInt220 / 2;
                    Texture.anInt1467 = l2 + class9_1.anInt267 / 2;
                    ...
                    Texture.anInt1466 = k3;
                    Texture.anInt1467 = j4;
        ...
        DrawingArea.setDrawingArea(l1, i1, false, k1, j1);
    }
    ...
    private final void method107(int i, int j, Class30_Sub2_Sub2 class30_sub2_sub2, byte byte0, Class30_Sub2_Sub4_Sub1_Sub2 class30_sub2_sub4_sub1_sub2) {
        ...
        if ((i & 8) != 0) {
            ...
            if (l == ((Class30_Sub2_Sub4_Sub1) (class30_sub2_sub4_sub1_sub2)).anInt1526 && l != -1) {
                ...
                if (i3 == 2)
                    class30_sub2_sub4_sub1_sub2.anInt1530 = 0;
            } else if (l == -1 || ((Class30_Sub2_Sub4_Sub1) (class30_sub2_sub4_sub1_sub2)).anInt1526 == -1 || Class20.aClass20Array351[l].anInt359 >= Class20.aClass20Array351[((Class30_Sub2_Sub4_Sub1) (class30_sub2_sub4_sub1_sub2)).anInt1526].anInt359) {
    ...
    public final void method126(boolean flag) {
        ...
        DrawingArea.method336(3, 78, 97, 0xffffff, 3, 0);
        aClass15_1165.method237(0);
    }
    ...
    public final void method128(int i, int j, int k, int l) {
        ...
        i1 = j2;
        if (l >= 50) {
            anInt963 = Texture.anInt1466 + (i << 9) / l;
            anInt964 = Texture.anInt1467 + (i1 << 9) / l;
            return;
        } else {
            anInt963 = -1;
            anInt964 = -1;
                ...
                if ((k == 3 || k == 7) && (k == 7 || anInt845 == 0 || anInt845 == 1 && method109(false, s))) {
                    ...
                    if (super.anInt20 > 4 && super.anInt21 - 4 > l - 10 && super.anInt21 - 4 <= l + 3) {
                        ...
                        if (super.anInt20 < 4 + i1) {
                            if (anInt863 >= 1) {
                                aStringArray1199[anInt1133] = "Traxxas-Scape!@whi@" + s;
    ...
    public final void method135(boolean var1, boolean var2) {
        this.method64(0);
        this.aClass15_1109.method237(0);
        this.aClass30_Sub2_Sub1_Sub2_966.method361(0, 16083, 0);
        short var3 = 360;
        short var4 = 200;
        if(!var2) {
           int var5;
           ...
           if(this.anInt833 == 0) {
              var5 = var4 / 2 + 80;
              this.aClass30_Sub2_Sub1_Sub4_1270.method382(7711145, var3 / 2, this.anInt939, this.onDemandFetcher.aString1333, var5, true);
              var5 = var4 / 2 - 70;
              this.aClass30_Sub2_Sub1_Sub4_1272.method382(16776960, var3 / 2, this.anInt939, "@whi@Welcome to GodzHell", var5, true);
              var5 = var4 / 2 - 50;
              this.aClass30_Sub2_Sub1_Sub4_1272.method382(16776960, var3 / 2, this.anInt939, "@whi@@ GodzHell.com", var5, true);
              var5 = var4 / 2 - 20;
              this.aClass30_Sub2_Sub1_Sub4_1272.method382(16711680, var3 / 2, this.anInt939, "@whi@New and Existing players click Enter to play", var5, true);
              var5 += 30;
              var6 = var3 / 2 - 80;
              var7 = var4 / 2 + 20;
              this.aClass30_Sub2_Sub1_Sub2_967.method361(var6 - 73, 16083, var7 - 20);
              this.aClass30_Sub2_Sub1_Sub4_1272.method382(16777215, var6, this.anInt939, "@whi@  About", var7 + 5, true);
              var6 = var3 / 2 + 80;
              this.aClass30_Sub2_Sub1_Sub2_967.method361(var6 - 73, 16083, var7 - 20);
              this.aClass30_Sub2_Sub1_Sub4_1272.method382(16777215, var6, this.anInt939, "@whi@Enter", var7 + 5, true);
           }

           if(this.anInt833 == 2) {
              var5 = var4 / 2 - 40;
              if(this.aString1266.length() > 0) {
                 this.aClass30_Sub2_Sub1_Sub4_1272.method382(16776960, var3 / 2, this.anInt939, "@whi@Entern your name and password to begin", var5 - 15, true);
                 this.aClass30_Sub2_Sub1_Sub4_1272.method382(16776960, var3 / 2, this.anInt939, this.aString1267, var5, true);
                 var5 += 15;
              } else {
                 this.aClass30_Sub2_Sub1_Sub4_1272.method382(16776960, var3 / 2, this.anInt939, this.aString1267, var5 - 7, true);
                 var5 += 15;
              }

              var5 += 0;
              this.aClass30_Sub2_Sub1_Sub4_1272.method389(false, true, var3 / 2 - 90, 16777215, "@whi@Character Name: " + this.aString1173 + (this.anInt1216 == 0 & anInt1161 % 40 < 20?"@xxx@|":""), var5);
              var5 += 15;
              this.aClass30_Sub2_Sub1_Sub4_1272.method389(false, true, var3 / 2 - 90, 16777215, "@whi@Password: " + Class50.method588(this.aString1174, 0) + (this.anInt1216 == 1 & this.anInt1105 % 40 < 20?"|":""), var5);
              var5 += 30;
              this.aClass30_Sub2_Sub1_Sub4_1272.method389(false, true, var3 / 2 - 160, 1048320, "@whi@New users enter a name and password to begin", var5);
              var5 += 70;
              var5 += 15;
              if(!var1) {
                 var6 = var3 / 2 - 80;
                 var7 = var4 / 2 + 50;
                 this.aClass30_Sub2_Sub1_Sub2_967.method361(var6 - 73, 16083, var7 - 20);
                 this.aClass30_Sub2_Sub1_Sub4_1272.method382(16777215, var6, this.anInt939, "@whi@Log in", var7 + 5, true);
                 var6 = var3 / 2 + 80;
                 this.aClass30_Sub2_Sub1_Sub2_967.method361(var6 - 73, 16083, var7 - 20);
                 this.aClass30_Sub2_Sub1_Sub4_1272.method382(16777215, var6, this.anInt939, "@whi@Cancel", var7 + 5, true);
              }
           }

           if(this.anInt833 == 3) {
              this.aClass30_Sub2_Sub1_Sub4_1272.method382(16777215, var3 / 2, this.anInt939, "GodzHell", var4 / 2 - 60, true);
              var5 = var4 / 2 - 35;
              this.aClass30_Sub2_Sub1_Sub4_1272.method382(16777215, var3 / 2, this.anInt939, "GodzHell.com", var5, true);
              var5 += 15;
              this.aClass30_Sub2_Sub1_Sub4_1272.method382(16777215, var3 / 2, this.anInt939, "Enjoy!", var5, true);
              var5 += 15;
              this.aClass30_Sub2_Sub1_Sub4_1272.method382(16777215, var3 / 2, this.anInt939, "Created by Traxxas!", var5, true);
              var5 += 15;
              this.aClass30_Sub2_Sub1_Sub4_1272.method382(16777215, var3 / 2, this.anInt939, " ", var5, true);
              var5 += 15;
              this.aClass30_Sub2_Sub1_Sub4_1272.method382(16777215, var3 / 2, this.anInt939, "", var5, true);
              var5 += 15;
              this.aClass30_Sub2_Sub1_Sub4_1272.method382('\u99ff', var3 / 2, this.anInt939, "", var5, true);
              var5 += 15;
              var6 = var3 / 2;
              var7 = var4 / 2 + 50;
              this.aClass30_Sub2_Sub1_Sub2_967.method361(var6 - 73, 16083, var7 - 20);
              this.aClass30_Sub2_Sub1_Sub4_1272.method382(3394815, var6, this.anInt939, "@whi@Back", var7 + 5, true);
           }

           this.aClass15_1109.method238(171, 23680, super.aGraphics12, 202);
           if(this.aBoolean1255) {
              this.aBoolean1255 = false;
              this.aClass15_1107.method238(0, 23680, super.aGraphics12, 128);
              this.aClass15_1108.method238(371, 23680, super.aGraphics12, 202);
              this.aClass15_1112.method238(265, 23680, super.aGraphics12, 0);
              this.aClass15_1113.method238(265, 23680, super.aGraphics12, 562);
              this.aClass15_1114.method238(171, 23680, super.aGraphics12, 128);
              this.aClass15_1115.method238(171, 23680, super.aGraphics12, 562);
           }
...
//                method58(25106);
    ...
    public final void method140(boolean var1) {
        if(!var1) {
        ...
        int var3;
        if(this.anInt833 == 0) {
           var2 = super.anInt10 / 2 - 80;
           var3 = super.anInt11 / 2 + 20;
           var3 += 20;
           if(super.anInt26 == 1 && super.anInt27 >= var2 - 75 && super.anInt27 <= var2 + 75 && super.anInt28 >= var3 - 20 && super.anInt28 <= var3 + 20) {
              this.anInt833 = 3;
              this.anInt1216 = 0;
           }
           ...
           var2 = super.anInt10 / 2 + 80;
           if(super.anInt26 == 1 && super.anInt27 >= var2 - 75 && super.anInt27 <= var2 + 75 && super.anInt28 >= var3 - 20 && super.anInt28 <= var3 + 20) {
              this.aString1266 = "@whi@";
              this.aString1267 = "@whi@";
              this.anInt833 = 2;
              this.anInt1216 = 0;
              return;
           }
           ...
           if(this.anInt833 == 2) {
              var2 = super.anInt11 / 2 - 40;
              var2 += 30;
              var2 += 25;
              if(super.anInt26 == 1 && super.anInt28 >= var2 - 15 && super.anInt28 < var2) {
                 this.anInt1216 = 0;
              }
              ...
              var2 += 15;
              var3 = super.anInt10 / 2 - 80;
              int var4 = super.anInt11 / 2 + 50;
              var4 += 20;
              if(super.anInt26 == 1 && super.anInt27 >= var3 - 75 && super.anInt27 <= var3 + 75 && super.anInt28 >= var4 - 20 && super.anInt28 <= var4 + 20) {
                 this.anInt1038 = 0;
                 this.method84(this.aString1173, this.aString1174, false);
                 if(this.aBoolean1157) {
                    return;
                 }
              }
              ...
              while(true) {
                 ...
                 while(true) {
                    if(var7 < aString1162.length()) {
                       if(var5 != aString1162.charAt(var7)) {
                          ++var7;
                          continue;
                       }
                    ...
                    if(this.anInt1216 == 0) {
                       if(var5 == 8 && this.aString1173.length() > 0) {
                          this.aString1173 = this.aString1173.substring(0, this.aString1173.length() - 1);
                       }
                       ...
                       if(var6) {
                          this.aString1173 = this.aString1173 + (char)var5;
                       }

                       if(this.aString1173.length() > 12) {
                          this.aString1173 = this.aString1173.substring(0, 12);
                       }
                       break;
                    }

                    if(this.anInt1216 == 1) {
                       if(var5 == 8 && this.aString1174.length() > 0) {
                          this.aString1174 = this.aString1174.substring(0, this.aString1174.length() - 1);
                       }
                       ...
                       if(var6) {
                          this.aString1174 = this.aString1174 + (char)var5;
                       }

                       if(this.aString1174.length() > 20) {
                          this.aString1174 = this.aString1174.substring(0, 20);
                       }
                       break;
                    }

                    if(this.anInt1216 == 2) {
                       if(var5 == 8 && server.length() > 0) {
           ...
           if(this.anInt833 == 3) {
              var2 = super.anInt10 / 2;
              var3 = super.anInt11 / 2 + 50;
              var3 += 20;
              if(super.anInt26 == 1 && super.anInt27 >= var2 - 75 && super.anInt27 <= var2 + 75 && super.anInt28 >= var3 - 20 && super.anInt28 <= var3 + 20) {
                 this.anInt833 = 0;
              }
    ...
    public final boolean method145(boolean flag) {
        ...
        try {
            ...
            if (anInt1008 == 74) {
                int songID = aClass30_Sub2_Sub2_1083.method434((byte) 108);
                if (songID == 65535)
                	songID = -1;
            ...
            if (anInt1008 == 121) {
                int songId  = aClass30_Sub2_Sub2_1083.method436((byte) -74);
                int songDelay = aClass30_Sub2_Sub2_1083.method435(true);
            ...
            if (anInt1008 == 73 || anInt1008 == 241) {
                ...
                aLong824 = System.currentTimeMillis();
                aClass15_1165.method237(0);
                this.aClass30_Sub2_Sub1_Sub4_1271.method381(0, "Loading - Please wait for GodzHell...", 23693, 151, 257);
                this.aClass30_Sub2_Sub1_Sub4_1271.method381(16777215, "Loading - Please wait for GodzHell...", 23693, 150, 256);
                this.aClass15_1165.method238(4, 23680, super.aGraphics12, 4);
                if (anInt1008 == 73) {
                    int k16 = 0;
    ...
    public final void method146(byte byte0) {
        ...
        if (byte0 != 1) {
            ...
            if(FogToggle) {            
            	double fogDistance = Math.sqrt(Math.pow(anInt859, 2));
    ...
    public client() {
        ...
        aBoolean880 = false;
        aString881 = "";
        server = settings.localHost ? settings.localAddress : settings.liveAddress;//"185.219.132.249";
        port = "43594";
        anInt882 = -30815;
        anInt883 = 533;
        anInt884 = -1;
    ...
    private Class42_Sub1 onDemandFetcher;
